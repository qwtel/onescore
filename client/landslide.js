...
(function() {
  var AppRouter, Router, categories, findTags, focusById, getThreadId, getUsername, hardReset, items, makeOkCancelHandler, positionActivityModal, softReset, wrapTags,
  ...
  _.extend(Template.titleSuggestions, {
    events: {
      'click .vote': function(e) {
        ...
        return Meteor.call('updateTitleScore', this._id);
      }
    },
    titles: function() {
      var id, titles;
