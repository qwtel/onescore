...
(function() {
  var calculateScore, hotScore, naiveScore, notify, patch, updateScore, wilsonScore;
  ...
  Meteor.methods({
    ...
    newAchievement: function(data) {
      ...
      if (Meteor.user().newAchievementCreated + 30 * 1000 > time) {
        return 0;
      }
